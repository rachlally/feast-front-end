    ...
    let searchLong;
      function onPlaceChanged () {
        ...
        if (autocomplete !== null) {
            ...
            console.log((autocomplete.getPlace().geometry.viewport.Wa.hi + autocomplete.getPlace().geometry.viewport.Wa.lo) / 2)
            searchLat=(autocomplete.getPlace().geometry.viewport.Wa.hi + autocomplete.getPlace().geometry.viewport.Wa.lo) / 2
             //search coordinates logging
            console.log((autocomplete.getPlace().geometry.viewport.Ia.hi + autocomplete.getPlace().geometry.viewport.Ia.lo) /2)
            searchLong=(autocomplete.getPlace().geometry.viewport.Ia.hi + autocomplete.getPlace().geometry.viewport.Ia.lo) /2
